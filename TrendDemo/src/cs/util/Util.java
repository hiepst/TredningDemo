...
public final class Util {
	 ...
	 *
	 * @param aLow
	 *            less than or equal to <tt>aHigh</tt>.
	 */
	 ...
	 * <tt>AbstractCollection.toString</tt> into a <tt>List</tt> of
	 * <tt>String</tt> objects.
	 * 
	 * <P>
	 * Intended for use as an aid in parsing collections of objects which were
	 * stored in their <tt>toString</tt> form. This method will not parse such
	 * <tt>String</tt>s into the original objects, but will aid in doing so by
	 * tokenizing it into its parts.
	 *
	 * @param aText
	 *            has format of <tt>AbstractCollection.toString</tt>
	...
	public static boolean isZeroMoney(BigDecimal aMoney) {
		return aMoney.equals(Consts.ZERO_MONEY) || aMoney.equals(Consts.ZERO_MONEY_WITH_DECIMAL);
	}
	 ...
	 *
	 * <P>
	 * The conventional logger names are taken as
	 * <tt>aClass.getPackage().getName()</tt>.
	 * 
	 * <P>
	 * Logger names appearing in the <tt>logging.properties</tt> config file
