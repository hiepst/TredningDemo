...
public final class Theme {
	...
	/*
	 * Implementation Note: This item has not been converted to an enum class,
	 * since it contains so many data-related settings.
	 */
	 ...
	 *
	 * @param aText
	 *            possibly-null text which may map to a Theme.
	 * @return null if <tt>aText</tt> is null, else try to match to a known
	 *         <tt>Theme</tt>.
	 * @throws IllegalArgumentException
	 *             if <tt>aText</tt> cannot be matched to a known theme.
	 */
	...
	private static class LargeFont extends Default {
		...
		private final FontUIResource fWindowTitleFont = new FontUIResource("Dialog", Font.BOLD, 18);
	...
	private static class LowVision extends LargeFont {
		...
		public void addCustomEntriesToTable(UIDefaults aTable) {
			...
			aTable.put("InternalFrame.closeIcon", MetalIconFactory.getInternalFrameCloseIcon(fInternalFrameIconSize));
