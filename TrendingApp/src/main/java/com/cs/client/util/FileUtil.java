 ...
 * 
 * <P>
 * Assumes UTF-8 encoding of the files.
 */
public final class FileUtil {
	 ...
	 * 
	 * @param aName
	 *            name of a file, relative to the location of the given class.
	 *            Usually, the file is in the same directory as the class that
	 *            is using it; in that case, the file name is just the simple
	 *            file name.
	 */
