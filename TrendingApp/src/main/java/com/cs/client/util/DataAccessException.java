 ...
 * regarding the data storage mechanism. See <a
 * href=http://www.javapractices.com/Topic77.cjp>Data Exception Wrapping</a>
 * topic for discussion.
 *
 * <P>
 * Every constructor maps to a corresponding <tt>Exception</tt> constructor. See
 * <tt>Exception</tt> for all conditions on constructor arguments.
 *
 * <P>
 * <tt>Throwable.getStackTrace</tt> returns all underlying exceptions.
