 ...
 *
 * <P>
 * All constants must be immutable. No instances of this class can be
 * constructed.
 *
 * <P>
 * The Java Look and Feel Design Guidelines recommend that components be spaced
 * using this scheme :
 * <ul>
 ...
 * second scheme, and use <tt>6*N-1</tt> pixel spacings (since this is the more
 * common case).
 */
public final class UiConsts {
	...
	/**
	 * Maximum length for some <tt>JLabel</tt>s, beyond which the text will be
	 * truncated. See {@link UiUtil#addSimpleDisplayField}.
	 */
