 ...
 *
 * <P>
 * Replace <tt>if</tt> statements at the start of a method with more compact
 * method calls.
 */
public final class Args {
	 ...
	 *
	 * @param aLow
	 *            is less than or equal to <tt>aHigh</tt>.
	 */
	...
	/**
	 * Throw an <tt>IllegalArgumentException</tt> only if
	 * <tt>aCollection.isEmpty</tt> returns <tt>true</tt>.
	 */
