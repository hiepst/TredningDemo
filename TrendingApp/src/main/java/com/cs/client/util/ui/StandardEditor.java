 ...
 * manipulated), and the action taken by the <tt>OK</tt> button.
 *
 * <P>
 * Services of a <tt>StandardEditor</tt> include:
 * <ul>
 ...
 * guidelines.
 * <li>uniform naming style for dialog title, with the application name
 * appearing first
...
public abstract class StandardEditor {
	 ...
	 *            application; must have content.
	 * @param aParent
	 *            window to which this dialog is attached.
	 * @param aCloseAction
	...
	protected enum CloseAction {
		DISPOSE(JDialog.DISPOSE_ON_CLOSE), HIDE(JDialog.HIDE_ON_CLOSE);
		int getValue() {
			return fAction;
		}
	 ...
	 * related to this dialog; this GUI will be placed above the <tt>OK</tt> and
	 * <tt>Cancel</tt> buttons, in a standard manner.
	 */
