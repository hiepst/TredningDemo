...
public class TrendAppMenuBar extends JMenuBar {
	...
	public void init() {
		...
		newTabMenuItem.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_T, ActionEvent.CTRL_MASK));

		newWindowMenuItem = new JMenuItem("New Window", KeyEvent.VK_N);
		newWindowMenuItem.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_N, ActionEvent.CTRL_MASK));
		...
		exportToCsvMenuItem.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_X, ActionEvent.CTRL_MASK));
