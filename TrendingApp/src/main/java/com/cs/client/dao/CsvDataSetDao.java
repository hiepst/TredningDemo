...
public class CsvDataSetDao implements DatasetDao {
	...
	public void addData(String displayName) {
		CassetteDataPoint dataPoint = DataSourceUtil.getCassetteDataPoint(displayName);
	...
	public void addMovingAverage(int periodCount, int skip) {
		...
		avgSkip = skip;
		movingAverageSeries = MovingAverage.createMovingAverage(s, name, periodCount, skip);
